...
class TransmissionSchedulerUnitTest : public TransmissionScheduler
{
    public:
...
class TransmissionScheduleTest : public ::testing::Test
{
    ...
    protected:
        TransmissionSchedulerUnitTest scheduler;
};
...
TEST_F(TransmissionScheduleTest, multiAdd)
{
    ...
    std::list<std::shared_ptr<TransmissionScheduler::Transmission>>::const_iterator iter = schedule.cbegin();
...
{
    std::shared_ptr<const TransmissionScheduler::Transmission> item = scheduler.popNext(1);
